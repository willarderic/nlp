...
#+begin_src python :results output
from nltk.sem import *
sent1 = ["Suzie sees Noosa"]
print()
print(sent1[0])
results = util.interpret_sents(sent1, 'grammars/sample_grammars/sem2.fcfg')
...
print()
print(sent2[0])
results = util.interpret_sents(sent2, 'grammars/sample_grammars/sem2.fcfg')
for result in results:
  for (synrep, semrep) in result:
    print(semrep)
    print(synrep)
...
print()
print(sent3[0])
results = util.interpret_sents(sent3, 'grammars/sample_grammars/sem2.fcfg')
for result in results:
  for (synrep, semrep) in result:
    print(semrep)
    print(synrep)
